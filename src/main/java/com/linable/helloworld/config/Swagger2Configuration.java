...
public class Swagger2Configuration {
	...
	public Docket accessToken() {
		return new Docket(DocumentationType.SWAGGER_2).groupName("helloworld")// 定义�?
				.select() // 选择那些路径和api会生成document
				.apis(RequestHandlerSelectors.basePackage("com.linable.helloworld.controller")) // 拦截的包路径
				.paths(regex("/*"))// 拦截的接口路�?
				.build() // 创建
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()//
				...
				//.license("Apache License Version 2.0")// �?源协�?
